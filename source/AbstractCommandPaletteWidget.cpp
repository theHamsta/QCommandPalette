...
AbstractCommandPaletteWidget::AbstractCommandPaletteWidget(AbstractCommandPaletteEngine* engine, QWidget* parent)
    : QWidget(parent)
{
    ...
    connect(m_engine, &AbstractCommandPaletteEngine::actionsFound, this,
            &AbstractCommandPaletteWidget::onSearchResultsReady);
    // 	connect( m_shortcutNextSuggestion, &QShortcut::activated, this,
    // &AbstractCommandPaletteWidget::onNextSuggestionRequested ); 	connect( m_shortcutPreviousSuggestion,
    // &QShortcut::activated, this, &AbstractCommandPaletteWidget::onPreviousSuggestionRequested );
}
...
void AbstractCommandPaletteWidget::keyReleaseEvent(QKeyEvent* event) { event->accept(); }
